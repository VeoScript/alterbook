...
type CardFollowingProps = (props: Omit<UserInterface, 'id' | 'email' | 'shortbio' | 'followers' | 'following'>) => JSX.Element;

const CardFollowing: CardFollowingProps = ({ image, username, _count }) => {
  return (
